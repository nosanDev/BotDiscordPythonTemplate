...
from commandes.help import help_class
help_class.commande(client, tree)

# # ---Clear---

# from commandes.clear import clear_class
# clear_class.commande(client, tree)

# ---Ping---

from commandes.ping import ping_class
ping_class.commande(client, tree)
